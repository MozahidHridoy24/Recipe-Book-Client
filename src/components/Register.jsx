...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-base-200 flex items-center justify-center px-4 pb-16">
      <div className="w-full max-w-md shadow-lg bg-base-100 text-base-content p-8 rounded-lg">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div>
            <label className="label">
              <span className="label-text font-semibold text-amber-500">
                Name
              </span>
            </label>
            <input
